    ...
    <div className="flex min-h-screen flex-col bg-white text-slate-900">
      ...
      <main className="flex-1 py-16 sm:py-24">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 prose prose-slate prose-a:text-blue-600">
          ...
          <h3 className="font-bold mt-4">2.2 Information Collected Automatically</h3>
          ...
          <h3 className="font-bold mt-4">6.2 Deletion Requests</h3>
          ...
          <h2 className="font-bold mt-6">7. Cookies</h2>
          ...
          <h2 className="font-bold mt-6">9. Your Data Protection Rights</h2>
          ...
          <h2 className="font-bold mt-6">10. Security</h2>
          ...
          <h2 className="font-bold mt-6">12. Changes to This Policy</h2>
          ...
          <h2 className="font-bold mt-6">13. Contact</h2>
